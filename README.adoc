...
Run the main method from link:demo/src/main/java/ga/overfullstack/pokemon/now/App.kt[App.kt] and see it in action with link:demo/src/test/resources/pokemon.http[pokemon.http]
