...
class PokemonCollectorTest {
  ...
  void collectPokemon() {
    final var pokemonHttpFake = new PokemonHttp() {
      @Override
    ...
    final var pokemonDbFake = new PokemonDao() {
      @Override
    ...
    new PokemonCollector(pokemonDbFake, pokemonHttpFake, Mockito.mock(Logger.class)).play(POKEMON_OFFSET_TO_FETCH, POKEMON_LIMIT_TO_FETCH);
  }
}
